...
function gerirgame(){
	barraplanet.style.width=lifeplanet+"px";
		if(contbombs<=0){
			jogo=false;
...
alert("o jogo vai começar save the word");
telas.style.display="block";
barraplanet=document.getElementById("barraplaneta");
barraplanet.style.width=lifeplanet+"px";


document.getElementById("btnjogar").addEventListener("click", restart);
